...
def add_global_flags(parser):
    ...
    parser.add_option("-R", "--repo",
                      ...
                      help="set repository location (default: %s)" % (defaults['repository']))
    ...
    parser.add_option("-C", "--config",
                      ...
                      help="set configuration file location (default: %s)" % (defaults['config_file']))

    parser.add_option("-H", "--home",
                      type="string", dest="homedir",
                      help="set home directory location (default: %s)" % (defaults['homedir']))
...
def check_repository_exists():
    if not os.path.exists(settings['repository']):
        print('Error: Could not find dotfiles repository \"%s\"' % (settings['repository']))
...
def main():
    ...
    settings['homedir'] = realpath_expanduser(cli_opts.homedir or defaults['homedir'])
    settings['config_file'] = realpath_expanduser(cli_opts.config_file or defaults['config_file'])
